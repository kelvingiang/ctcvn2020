...
<body style="padding-left: 8px">
    ...
    <div>
        <table cellpadding="0" Cellspacing='0'
            style='width: 700px; margin-top: 20px; border-left: 1px solid #000; border-right:  1px solid #666 '>
            ...
            <tr style='height: 40px; border-bottom:  #666 solid 1px; font-size: 15px;'>
                ...
                <td style='border-bottom:  #666 dotted 1px'> <?php echo get_country($val[0]['Country']) ?></td>
