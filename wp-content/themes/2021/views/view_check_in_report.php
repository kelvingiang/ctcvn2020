...
<div class="report_head" style="height: 60px; margin-top: 20px">
    <a style=' margin-top: 2px; margin-right: 20px; letter-spacing: 4px ' class="button button-primary button-large"
        href="<?php echo home_url('print-check-in'); ?>" target="_blank"> 列印報表</a>

    <a style=' margin-top: 2px; margin-right: 40px; letter-spacing: 4px ' class="button button-primary button-large"
    ...
    <table id="bao_cao">
        <tr style=" background-color: #2B95FD; text-align: center; ">
            <td style="width: 100px">
                <h3 style="color: white"> 分 會 </h3>
            </td>
            <td style="width: 100px">
                <h3 style="color: white"> 登 記</h3>
            </td>
            <td style="width: 100px">
                <h3 style="color: white"> 出席</h3>
            </td>
            <td style="width: 100px">
                <h3 style="color: white"> 比率</h3>
            </td>
        </tr>
...
<div class="report_content">
    <div>
        <table cellpadding="0" Cellspacing='0'
            style='width: 98%; margin-top: 20px; border-left: 1px solid #000; border-right:  1px solid #000 '>
