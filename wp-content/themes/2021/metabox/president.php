    ...
    <div class="cell-two">
        <select id="sel_Country" name="sel_country">
            ...
            <option value='<?php echo $key ?>'
                <?php echo get_post_meta($post->ID, '_president_branch', true)  == $key ? 'selected' : '' ?>>
                <?php echo $val ?> </option>
            <?php } ?>
        </select>
    </div>
...
<div class="row-one-clo">
    ...
    <div class="cell-two"><input type="text" id="txt_term" name="txt_term"
            value="<?php echo get_post_meta($post->ID, '_president_term', true) ?>" /></div>
</div>
<div class="row-one-clo">
    <div class="cell-one"><label class="admin-title">年 度</label> </div>
    <div class="cell-two"><input type="text" id="txt_year" name="txt_year"
            value="<?php echo get_post_meta($post->ID, '_president_year', true) ?>" /></div>
</div>
