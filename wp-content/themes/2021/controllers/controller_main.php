...
class Admin_Controller_Main
{
    ...
    public function post_brach()
    {
        if ($this->_controller_options['controller_brach'] == TRUE) {
            require_once(DIR_CONTROLLER . 'controller_brach.php');
            new Admin_Controller_Brach();
        }
    }
