    ...
    <div class="add_new_space">
        <form id="f_recruit_dangtuyen" method="post" action="#">
            <div id="tab-2">
                ...
                <!--so nguoi can tuyen -->
                <!-- <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12"> <label for="sex" class="label-title"><?php //_e('Sex', 'suite'); 
                                                                                                    ?></label></div>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                ...
                <!-- <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-4"> <label
                            class="label-title"><?php //_e('Age', 'suite'); 
                                                ?></label></div>
                    <div class="col-md-4 col-sm-4 col-xs-8"><input type="text" style="width: 88%" class="type-number"
                            maxlength="2" name="txt_age_from" id="txt_age_from" value="<?php //echo $age_from 
                                                                                        ?>"></div>
                    <div class="col-md-1 col-sm-1 col-xs-4"><label
                            class="label-title"><?php //_e('To', 'suite'); 
                                                ?></label></div>
                    <div class="col-md-4 col-sm-4 col-xs-8"><input type="text" style="width: 88%" class="type-number "
                            maxlength="2" name="txt_age_to" id="txt_age_to" value="<?php //echo $age_to 
                                                                                    ?>"> </div>
