            ...
            <form id="f_recruit_ungtuyen" method ="post" action="#"  enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <lable for="status" class="label-title" style="margin-right: 30px; font-weight: bold" ><?php _e('Active', 'suite') ?>,
                            <i class="e">Active</i>,
                ...
                <div class="row" style=" display: block">
                    ...
                    <div class='col-md-3 col-sm-3 col-xs-12'>
                        <?php if (!empty($m_img)) { ?>
                            <img src="<?php echo WB_URL_IMAGES_APPLY . $m_img ?>" width="100px"/>
                        <?php } ?>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <select id="sel_sex" name="sel_sex" class="selectmenu" style="width: 180px">
                            <option value="1" <?php echo $r_sex == 1 ? 'selected="selected"' : ''; ?>><?php _e('Male', 'suite'); ?></option>
                            <option value="2" <?php echo $r_sex == 2 ? 'selected="selected"' : ''; ?>><?php _e('Female', 'suite'); ?></option>
                        </select>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">             
                        ...
                        <script>
                            var editor = CKEDITOR.replace('another', {customConfig: 'custom-config_no-img.js'});
                            CKFinder.setupCKEditor(another, '<?php echo get_lib_uri('ckfinder/') ?>');
                        </script>
                    </div>
                </div> 
                <div style=" text-align: center; padding: 25px">
                    <input id="btn-submit" type="submit" class="btn btn-primary" value="<?php echo isset($_GET['id']) ? _e('Update', 'suite') : _e('Submit', 'suite'); ?> Gởi" />
                    <?php if (isset($_GET['id'])) { ?>
                        <input id="btn_reset" type="reset" class="btn btn-primary" value="<?php _e('Cancel', 'suite'); ?> Huỷ" onclick="javascript:window.location = '<?php echo home_url('recruit/?dt=1') ?>';" />
                    <?php } else { ?>
                        <input id="btn-reset" type="reset" class="btn btn-primary" value= '<?php _e('Reset', 'suite'); ?> Viết lại' />
                    <?php } ?>
                </div>
            </form>
        </div>
        ...
        while ($myQuery->have_posts()):
            ...
            <div class ="row-item">
                ...
                <span style=" float: right">
                    ...
                    <a class="edit-item" href="<?php echo esc_attr(add_query_arg('id', $post->ID)) ?>"> <?php _e('Edit', 'suite'); ?><i> Sửa</i> </a> |
                    <a href="#" class="del" data-id="del-<?php echo $post->ID ?>"  data-href="<?php echo esc_attr(add_query_arg('del', $post->ID)) ?>" data-title=" <?php echo get_the_title($post->ID); ?>" data-toggle="modal" data-target="#confirm-delete"> <?php _e('Delete', 'suite'); ?> <i>xoá</i> </a>
                </span>
            </div>
