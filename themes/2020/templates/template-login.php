            ...
            <div style=" margin-top: 20px">
                <form id="f_login" name="f_login" method="post" action="">
                    <div id="row">
                        ...
                        <div class=' col-md-12'><p id="strMessageLogin" style=" margin-top:5px; color: red; font-weight: bold"></p></div>
            ...
            <div  style=" border: 1px solid #B7C1CC; border-radius: 4px;  padding: 15px; background-color:#DBDBDB ">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                        <h5 style="font-weight: bold;  font-size: 15px"> <a href="#" data-toggle="modal" data-target="#myModal" style="margin-right: 10px"><img class="avatar" src="<?php echo get_image('avata/' . $m_image); ?>"/></a>   
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <label><a href="<?php echo home_url('/register/') ?>" class="btn btn-primary" >帳號資料 <i class="my_i"> thông tin tài khoản</i></a></label>
                    </div>
                </div>
                <div  class="row" style=" text-align: left; margin-top: 10px">
                    ...
                    if ($_SESSION['login_type'] == 'recruit') {
                        ...
                        ?>
                        <div class="col-md-3 col-sm-6 col-xs-3 " style="margin: 0px"><a href="<?php echo home_url('/recruit/?dt=4') ?>" class="btn btn-primary" style="letter-spacing: 3px"><?php _e('dangtuyen', 'suite'); ?></a></div>
                        <?php
                    } elseif ($_SESSION['login_type'] == 'apply') {
                        //  wp_redirect(home_url('recruiter'));
                        ?>
                        <div class="col-md-3 col-sm-6 col-xs-3" style="margin:0px"><a href="<?php echo home_url('/recruit/?dt=3') ?>" class="btn btn-primary">履歷 <i  class="my_i">lý lịch</i></a></div> 
                    <?php } else { ?>
                        <div class="col-md-3 col-sm-6 col-xs-3"><a href="<?php echo home_url('/article/') ?>" class="btn btn-primary" style="letter-spacing: 3px"><?php _e('Article', 'suite'); ?></a></div>
                        <div class="col-md-3 col-sm-6 col-xs-3"><a href="<?php echo home_url('/recruit/?dt=4') ?>" class="btn btn-primary" style="letter-spacing: 3px"><?php _e('dangtuyen', 'suite'); ?></a></div>
                    <?php } ?>
        ...
        <form name="f-getPass" id="f-getPass" action="" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <image id="waiting-img"  name="waiting-img" src="<?php echo get_image('loading.gif') ?>"/>   
                    <div style=" clear: both"></div>
                </div>
                <div class="modal-body">
                    <div>
...
<script type="text/javascript">
    ...
    var objLoginData = {
        url: '<?php echo get_template_directory_uri() . '/ajax/login.php' ?>'
    };
// phan quen mat khau xin lai mat khau mmoi    
    var obForgetPass = {
        url: '<?php echo get_template_directory_uri() . '/ajax/forgetpass.php' ?>'
    };


//goi ajax de thay doi hinh avatar cua member
    var objAvatarData = {
        url: '<?php echo get_template_directory_uri() . '/ajax/changeavatar.php' ?>'
    };
