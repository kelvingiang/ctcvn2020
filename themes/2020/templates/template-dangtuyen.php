            ...
            <div id="tab-2">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <lable for="status"  style="margin-right: 30px; font-weight: bold" class="label-title" ><?php _e('Active', 'suite') ?></lable>
                ...
                <div class="row">
                    ...
                    <div class='col-md-9 col-sm-9 col-xs-12'> 
                        ...
                        <div class='col-md-12 col-sm-12 col-xs-12 error-text'> <label id="error_title"> <?php echo $_error['title']; ?></label></div>
                    </div>
                </div> <!-- title -->
                <div class="row">
                    ...
                    <div class='col-md-12 col-sm-12 col-xs-12 error-text'> <label> <?php echo $err_com_company_tw ?></label></div>
                </div> <!-- tw company -->
                <div class="row">
                    ...
                    <div class='col-md-12 col-sm-12 col-xs-12 error-text'> <label> <?php echo $err_com_company ?></label></div>
                </div> <!-- vn Company -->
                <div class="row">
                    ...
                    <div class='col-md-12 col-sm-12 col-xs-12 error-text'> <label> <?php echo $err_com_company_en ?></label></div>
                </div> <!-- en Company -->
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label> <?php echo $err_com_address ?></label></div>
                </div> <!-- dia chi -->
                <div class="row">   
                ...
                <div class="row"> 
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <script>
                            var editor = CKEDITOR.replace('editor', {customConfig: 'custom-config.js'});
                            CKFinder.setupCKEditor(editor, '<?php echo get_lib_uri('/ckfinder') ?>');
                        </script>
                    </div> 
                </div> <!-- gioi thieu cty -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label> <?php echo $err_com_career ?></label></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label> <?php echo $err_com_count ?></label></div>
                </div> <!--so nguoi can tuyen -->
                <div class="row" >
                    <div class="col-md-3 col-sm-3 col-xs-12"> <label for="sex" class="label-title" ><?php _e('Sex', 'suite'); ?></label></div> 
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select id="sel_sex" name="sel_sex" style="width: 180px">
                            <option value="3" <?php echo $com_sex == 3 ? 'selected="selected"' : '' ?> ><?php _e('Male/Female', 'suite'); ?></option>
                            <option value="1" <?php echo $com_sex == 1 ? 'selected="selected"' : '' ?> ><?php _e('Male', 'suite'); ?></option>
                            <option value="2" <?php echo $com_sex == 2 ? 'selected="selected"' : '' ?> ><?php _e('Female', 'suite'); ?></option>
                        </select>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label></label></div>
                </div><!-- gioi tinh -->
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label> <?php echo $err_com_date ?></label></div>
                </div>
                <?php
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-8"> 
                        <select id="sel_place" name="sel_place">
                            <?php foreach ($placeList as $key => $val) { ?>
                                <option value="<?php echo $key ?>" <?php echo $sel_place == $key ? 'selected="selected"' : '' ?>><?php echo $val ?></option>
                            <?php } ?>                            
                        </select>
                    </div>
                    <div class="col-md-5 col-sm-5 col-xs-12"><label id="error_place" style=" color: red; font-size: 12px; font-style:  italic"> <?php echo $err_place ?></label></div>
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label > </label></div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-8"> 
                        <select id="sel_career" name="sel_career">
                            <?php foreach ($careerList as $key => $val) { ?>
                                <option value="<?php echo $key ?>" <?php echo $sel_career == $key ? 'selected="selected"' : '' ?>><?php echo $val ?></option>
                            <?php } ?>                            
                        </select>
                    </div>
                    <div class="col-md-5 col-sm-5 col-xs-12"><label id="error_career" style=" color: red; font-size: 12px; font-style:  italic"> <?php echo $err_career ?></label></div>
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label> </label></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label> <?php echo $err_com_level ?></label></div>
                </div> <!-- trinh do -->
                <div class="row"> 
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label> <?php echo $err_com_experience ?></label></div>
                </div> <!-- kinh nghiem -->
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-4"> <label  class="label-title"><?php _e('Age', 'suite'); ?></label></div>
                    <div class="col-md-4 col-sm-4 col-xs-8"><input type="text" style="width: 88%" class="type-number" maxlength="2"  name="txt_age_from" id="txt_age_from"value="<?php echo $age_from ?>"></div>         
                    <div class="col-md-1 col-sm-1 col-xs-4"><label  class="label-title" ><?php _e('To', 'suite'); ?></label></div>         
                    <div class="col-md-4 col-sm-4 col-xs-8"><input type="text" style="width: 88%" class="type-number " maxlength="2"  name="txt_age_to" id="txt_age_to"value="<?php echo $age_to ?>"> </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 error-text"><label class="mess"> <?php echo $err_com_age ?></label></div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <script>
                            var another = CKEDITOR.replace('another', {customConfig: 'custom-config_no-img.js'});
                            CKFinder.setupCKEditor(another, '<?php echo get_lib_uri('ckfinder/') ?>');
                        </script>
                    </div> 
                </div> <!-- khac -->
...
if ($myQuery->have_posts()):
    ...
    while ($myQuery->have_posts()):
        ...
        <div class="row-item">  
           ...
           <!-- <label>Post at : <?php // echo $post->post_date                                                                           ?></label>-->
            <span style="float: right">
                <a href="<?php the_permalink() ?>" target="_blank"><?php _e('View', 'suite'); ?></a> | 
                <a class="edit_space" href="<?php echo esc_attr(add_query_arg('id', $post->ID)) ?>"> <?php _e('Edit', 'suite'); ?> </a> |
                <a href="#" class="del" data-id="del-<?php echo $post->ID ?>"  data-href="<?php echo esc_attr(add_query_arg('del', $post->ID)) ?>" data-title=" <?php echo get_the_title($post->ID); ?>" data-toggle="modal" data-target="#confirm-delete"> <?php _e('Delete', 'suite'); ?></a>
            </span>
        </div>
        <?php
    endwhile;
