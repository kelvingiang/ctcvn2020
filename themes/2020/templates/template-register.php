...
<form  id="f-register" name="f-register" method="post" action="">
    ...
    <div class="row">
        ...
        <div class='col-md-9'><input type="text" class="form-control"   required  oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')" 
    ...
    <div class="row">
        <div class='col-md-3'><label class="label-title" for="m_passf"> <?php _e('Password Confirm', 'suite'); ?> </label></div>
    ...
    <div class="row">
       ...
       <input type="text" style='margin-top: -2px; width:150px' oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"  onchange="this.setCustomValidity('')"  placeholder="<?php _e('名字', 'suite'); ?>"  name="m_firstname" id="m_firstname" value="<?php echo $firstname ?>" /></div>
        <div class='col-md-12 error-text'><label><?php echo $err_englishName ?></label></div>
    </div>
    <div class="row">
        <div class='col-md-3'><label class="label-title" for="m_passport"><?php _e('Passport', 'suite'); ?> </label></div>
    ...
    <div class="row">
        <div class='col-md-3'><label class="label-title" for="m_birthdate"><?php _e('Birth Of Date', 'suite'); ?> </label></div>
        <div class='col-md-9'>
    ...
    <div class="row">
        <div class=' col-md-3 '><label class="label-title" for="m_company"> <?php _e('Company', 'suite'); ?> </label></div>
    ...
    <div class="row">
        <div class=' col-md-3 '><label class="label-title" for="m_position"> <?php _e('Position', 'suite'); ?> </label></div>
    ...
    <div class="row">
        ...
        <div class=' col-md-9'><input type="text" maxlength="5" required  oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"  onchange="this.setCustomValidity('')" placeholder="<?php _e('Captcha', 'suite') ?>"  id="txtCaptcha" name="txtCaptcha" style='margin-top: -2px; margin-right:10px; width:170px' value="<?php echo $captcha ?>"><img src="<?php echo get_lib_uri('captcha/captcha.php'); ?>" onclick="this.src = '<?php echo get_lib_uri('captcha/captcha.php?reset=true&') ?>' + Math.random();" style="cursor:pointer"  /></div>
...
<div id="div-popup">
    <div id="div-alertInfo">
        ...
        <div id="alert-content"><h2><?php _e('congratulation your register success !','suite'); ?> </h2></div>
