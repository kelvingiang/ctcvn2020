    ...
    <body >
        <div id="main_bg" >
            <div class=" container-fluid ">
                <div class="row">
                    <div class="col-lg-12" style=" background-color: #f65900;  text-align: center; letter-spacing: 5px; color:#fff; font-size: 18px"><h1>越南台灣商會聯合總會</h1></div>
                    <div class="col-lg-12">
                        <?php
                            ...
                            <ul class="vertical-list">
                                ...
                                foreach ($lishiList as $val) {
                                    ...
                                    <li  style='width: 10%'>
                                        ...
                                        <div  class="img-cell"> 
                                            <img style="height: 180px" src="<?php echo WB_URL_IMAGES_VOTE . $val['img'] ?>" />
                                        </div>
