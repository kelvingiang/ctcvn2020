...
<div class="row">
    <div class="col-xl-9 col-lg-9 col-md-8 col-sm-4 col-12">
        <div class='head-title'>
            <div class="title">
                <h2 class="head"> <?php _e('分會介紹', 'suite'); ?> </h2>
            </div>
        </div>
        <?php
        $arrRec1 = array(
                ...
                while ($myQuery1->have_posts()):
                    ...
                    <div class="brach-item">
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-md-12 col-sm-12 col-xs-12"> <h3><?php the_title() ?></h3> </div>
                           ...
                           <div class="col-md-2 col-sm-2 col-xs-2"> <!-- <a href=" <?php the_permalink() ?>" class="btn-sm"><?php _e('細 節', 'suite'); ?></a> --> </div>
                        </div>
                    </div>
                    <?php
                endwhile;
