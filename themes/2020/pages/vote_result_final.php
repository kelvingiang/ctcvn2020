                ...
                <div class="col-lg-12">
                    <ul class="result-list" style=" text-align: center">
                        ...
                        foreach ($lishiList as $val) {
                            ...
                            ?>
                            <li style="flex: 49%; height: 98vh; letter-spacing: 2px;   border-left: 1px solid #ccc; background-color: <?php echo $color ?>">
                                <div style=" font-weight: bold; font-size: 25px; height: 80px;  line-height: 80px; background-color:<?php echo $bg_color ?>   ; color: white">
                                    <?php echo $position ?>
                                </div>
                                ...
                                <div style="margin-bottom: 50px;  margin-top: 30px; max-height: 500px"> 
                                    <img style=" height: 400px; border-radius: 5px;
                                         ...
                                         border: 1px solid #999"  src="<?php echo WB_URL_IMAGES_VOTE . $val['img'] ?>" />
                                </div>
