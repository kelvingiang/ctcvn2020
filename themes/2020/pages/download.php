...
<div class="row">
    <div class="col-xl-9 col-lg-9 col-md-8 col-sm-8 col-12">
        ...
        <div>
            <img src="<?php echo WB_URL_IMAGES .'download-panner.jpg' ?>" style=" width: 99%;" />
        </div>
        ...
        <div class="download-space">
            ...
            foreach ($downloadList as $val) {
                ...
                <div class="download-item">
                    <a style=" display: block; text-decoration: none" target="_blank" href="<?php echo WB_URL_FILE . $val['file'] ?>">
                        <div>
                            <img src="<?php echo WB_URL_IMAGES . 'download/' . $val['img'] ?>" />
