...
if ($action == "add") {
    ...
    include_once MODEL_DIR . 'vote_model.php';
...
<div style="padding-top: 20px">
    ...
    <form action="" method="post" enctype="multipart/form-data" id="f-vote" name="f-vote" >
        ...
        <div class="row-one-clo" style=" margin-bottom: 70px ">
            ...
            <div class="cell-two">
                ...
                ?>
                <div id="show-img" style="background-image: url('<?php echo WB_URL_IMAGES_VOTE . $vote_img; ?>')"></div>  
...
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">候選職位</label></div>    
    <div class="cell-two">
...
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">當選職位</label></div>    
    <div class="cell-two">
...
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">同意票數</label></div>    
    <div class="cell-two"><input type="text" id="txt_agree" name="txt_agree"  class=" type-number" value="<?php echo $item['agree'] ?>"  /></div>
</div>
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">不同意票數</label></div>    
    <div class="cell-two"><input type="text" id="txt_not_agree" name="txt_not_agree"  class=" type-number" value="<?php echo $item['not_agree'] ?>"  /></div>
</div>
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">廢票數</label></div>    
    <div class="cell-two"><input type="text" id="txt_illegal" name="txt_illegal"  class=" type-number" value="<?php echo $item['illegal'] ?>"  /></div>
</div>
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">總票數</label></div>    
    <div class="cell-two"><input type="text" id="txt_total" name="txt_total"  class=" type-number" value="<?php echo $item['total'] ?>"  /></div>
</div>

<div class="row-all" style=" text-align: right">
