...
<!--        <li>
            <a style=' margin-right: 20px; letter-spacing: 4px ' 
               class="button button-primary button-large" 
               href="<?php //echo "admin.php?page=$page&action=export_member_table" ?>"> 導出 Member (table)</a>
        </li>-->
    </ul>
    <hr/>
    <ul>
        <li>
            <a style="background-color: green; color: white; border-radius: 5px; letter-spacing: 2px;  font-weight: bold "
               ...
               href="<?php echo "admin.php?page=$page&action=import_guests" ?>"> 導入 Guests</a>
        </li>
<!--        <li>
            <a style="background-color: green; color: white; border-radius: 5px; letter-spacing: 2px;  font-weight: bold "
               class="button button-large" 
               href="<?php //echo "admin.php?page=$page&action=import_member" ?>"> 導入 Member</a>
        </li>-->
    </ul>
    <hr/>
    <ul>
        ...
        <li>
            <a style='background-color: red; color: white; border-radius: 5px; letter-spacing: 2px;  font-weight: bold ' 
               class="button  button-large" 
               href="<?php echo "admin.php?page=$page&action=batch_qrcode" ?>">
                批次產生QRCode檔</a>
        </li>
        <li><a style='background-color: red; color: white; border-radius: 5px; letter-spacing: 2px;  font-weight: bold ' 
               class="button  button-large" 
               href="<?php echo "admin.php?page=$page&action=set_qrcode_name" ?>">
                產生QRCode含姓名(記得檢查姓名)</a>
        </li>
        <li><a style='background-color: red; color: white; border-radius: 5px; letter-spacing: 2px;  font-weight: bold ' 
               class="button  button-large" 
               href="<?php echo "admin.php?page=$page&action=set_qrcode_register" ?>">
