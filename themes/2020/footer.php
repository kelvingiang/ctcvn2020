...
<?php if (!is_page('check-in')) { ?>
    <div id="back-top-wrapper" >
        <a id="back-top"  >
            <img src="<?php echo get_image('up.png'); ?>" />
        </a>
    </div>   
    <?php wp_footer(); ?>
            ...
            <div class="footer-content">
                <div>
                    <table style="width: 100%">
                        <tr>
                            <td style="width: 25%"> <a href="<?php echo home_url('about-main'); ?>">總會章程</a>  </td>
                            <td style="width: 25%"> <a href="<?php echo home_url('about-brach'); ?>">聯絡商會</a>  </td>
                            <td style="width: 25%"> <a href="<?php echo home_url('info-main'); ?>">總會信息</a>  </td>
                            <td style="width: 25%"> <a href="<?php echo home_url('info-brach'); ?>">分會信息</a>  </td>
                        </tr>
                        <tr>
                            <td style="width: 25%"> <a href="http://vietnamsos.net" target="_blank">緊急醫院</a>  </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 25%"> <a href="<?php echo home_url('recruitments'); ?>">求職</a>  </td>
                        </tr>
                    </table>
                </div>
                <div class="copy-right">
                    ...
                    <div style=" text-align: right ">
                        <?php
                        require_once (CLASS_DIR . 'online-counter.php');
                    ...
                    <div style=" text-align: left">
                        ...
                        Copyright  &copy; - 2015  Design by <a rel="author" href="https://plus.google.com/u/0/106534001476073840633" target="_blank" >Digiwin Software (Vietnam) Co., Ltd.</a> 
                      <!--  Copyright  &copy; -<?php // echo date('Y');               ?> --- <?php //bloginfo('sitename')               ?> -->
                    </div> 
