...
<div class="row-one-clo">
    ...
    <div class="cell-two"><input type="text" id="txt_company" name="txt_company"
            value="<?php echo $item['company'] ?>" /></div>
</div>
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">同意票數</label></div>
    <div class="cell-two"><input type="text" id="txt_agree" name="txt_agree" class=" type-number"
            value="<?php echo $item['agree'] ?>" /></div>
</div>
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">不同意票數</label></div>
    <div class="cell-two"><input type="text" id="txt_not_agree" name="txt_not_agree" class=" type-number"
            value="<?php echo $item['not_agree'] ?>" /></div>
</div>
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">廢票數</label></div>
    <div class="cell-two"><input type="text" id="txt_illegal" name="txt_illegal" class=" type-number"
            value="<?php echo $item['illegal'] ?>" /></div>
</div>
<div class="row-one-clo">
    <div class="cell-one "><label class="label-admin">總票數</label></div>
    <div class="cell-two"><input type="text" id="txt_total" name="txt_total" class=" type-number"
            value="<?php echo $item['total'] ?>" /></div>
</div>
