            ...
            <div class="blue-group">
                ...
                <div style=" margin-top: 20px">
                    <form id="f_login" name="f_login" method="post" action="">
                        <div id="row">
                            <div class="col-md-12">
                                <label class='label-title'><?php _e('User Name or Full Name', 'suite'); ?><i style='color: #666'> Tài Khoản</i></label>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <label class='label-title'><?php _e('Password', 'suite') ?><i style="color: #666"> Mật Khẩu</i></label>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div style='text-align: center; margin: 10px 20px '>
                                ...
                                <button type="button" class="btn-my" name="btn_add_new" id="btn_add_new" style=" margin-right: 10px">
                                    <?php _e('登記'); ?><br><i> Đăng Ký</i>
                                </button>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#btn_add_new').click(function() {
            window.location = ('<?php echo home_url('/member-register/'); ?>');
        });
