...
?>
        ...
        <div class="row-one-column">
            <div class="col">
                ...
                <div class="cell-text">
                    <input type="text" required pattern=".{3,}" placeholder="小心輸入,此欄目以後不可修改" title="minlegh 5 chars" class="my-input" name="m_user" id="m_user" <?php echo (($m_user) ? 'disabled' : '') ?> value="<?php echo ((!isset($m_user) || $m_user != '') ? $m_user : ''); ?>" />
                </div>
        ...
        <div class="row-one-column">
            <div class="col">
                ...
                <div class="cell-text"><input type="email" class="my-input" required placeholder="小心輸入,此欄目以後不可修改" name="m_email" id="m_email" <?php echo $m_email == '' ? '' : 'disabled' ?> value="<?php echo ((!isset($m_email) || $m_email != '') ? $m_email : ''); ?>" /></div>
